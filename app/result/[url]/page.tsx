      ...
      <div className="backdrop-blur-xl bg-white/60 border border-white/80 shadow-lg rounded-2xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="p-0 relative aspect-square w-full max-w-md mx-auto lg:mx-0">
            <div className="absolute inset-0 bg-linear-to-br from-blue-200/20 to-purple-200/30 z-0"></div>
            <TikTokImage
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/90 via-black/50 to-transparent p-6 z-20">
          ...
          <div className="p-8 flex flex-col justify-between h-full">
            ...
            <div className="grid gap-4">
              <Button
                ...
                className="relative overflow-hidden transition-all duration-300 hover:shadow-lg bg-linear-to-r from-blue-600 to-blue-400 rounded-xl py-3 text-white font-medium w-full flex justify-center items-center"
              ...
              <Button
                ...
                className="relative overflow-hidden transition-all duration-300 hover:shadow-lg bg-linear-to-r from-blue-700 to-blue-500 rounded-xl py-3 text-white font-medium w-full flex justify-center items-center"
                disabled={downloadProgress?.isDownloading}
              >
                <Download className="mr-2" size={20} />
                Download HD Quality
